...
int main(int argc, char **argv)
{
    ...
    // Pose Goal
    tf2::Quaternion q;
    q.setRPY(-3.141, -1.173, 0.502);
    q = q.normalize();

    geometry_msgs::msg::PoseStamped target_pose;
    target_pose.header.frame_id = "base_link";
    target_pose.pose.position.x = 0.231;
    target_pose.pose.position.y = 0.126;
    target_pose.pose.position.z = 0.327;
